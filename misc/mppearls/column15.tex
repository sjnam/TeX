...
The Select algorithm has the same structure as Quicksort. Given $L\le K\le U,$
...
\vbox{
\centerline{\vbox{
\halign{&\strut\hbox to15pt{\hfil#}\cr
21&5&15&7&19&7&{\bf22}&75&65&39&25&73&98&95&53&39&27&63&46&58&82\cr
\noalign{\vskip-7pt}
\multispan{21}\hrulefill\cr}}}
\smallskip
\centerline{\vbox{
\halign{&\strut\hbox to15pt{\hfil#}\cr
&&&&&&&27&25&{\bf39}&65&73&98&95&53&75&39&63&46&58&82\cr
\noalign{\vskip-7pt}
&&&&&&&\multispan{14}\hrulefill\cr}}}

\centerline{\vbox{
\halign{&\strut\hbox to15pt{\hfil#}\cr
&&&&&&&&&&58&73&53&65&39&63&46&{\bf75}&98&95&82\cr
\noalign{\vskip-7pt}
&&&&&&&&&&\multispan{11}\hrulefill\cr}}}

\centerline{\vbox{
\halign{&\strut\hbox to15pt{\hfil#}\cr
&&&&&&&&&&46&39&{\bf53}&65&73&63&58&&&&\cr
\noalign{\vskip-7pt}
...
\centerline{\vbox{
\halign{&\strut\hbox to15pt{\hfil#}\cr
21&5&15&7&19&7&22&27&25&{\bf39}&39&46&53&65&73&63&58&75&98&95&82\cr
\noalign{\vskip-7pt}
\multispan{21}\hrulefill\cr}}}}
$$
...
is circled. Elements to its left have lesser values, while elements to its right
are greater than or equal to the partitioning value.
...
$RandInd(L,U)$ described in Section 13.1 which returns a random integer in the
range $L\ltdot U.$ The complete partioning code is
\begindisplay
\vbox{
\+${\it Swap}(X[L], X[{\it RandInt}(L,U)])$\cr
\+$M\leftarrow L$\cr
...
\+\qquad${\it Swap}(X[L],X[{\it RandInt}(L,U)])$\cr
...
We have analyzed two aspects of Hoare's selection algorithm: its answer is {\sl
correct}, and it computes that answer {\sl efficiently}. This exercise
...
Select program is correct. This column presented both an informal correctness
argument and pictures showing the algorithm at work (generated by the program
itself). Section 3.2 describes scaffolding for viewing the program at work and
for testing the program. Each of these analyses supports the others: watching
the program at work gives insight into its loop invariant, which in turn is
useful for testing.

I am also convinced that Select runs in $O(N)$ time on arrays with few
...
Select without performing all the work of the complete program. Problem 6
describes several additional programs with this flavor. While Select would use
sevral billion stpes on a set of size one billion, these programs can gather
information on the same computation in just a few dozen operations. These
...
\prob
Select partitions about a random element in the subrange. Study the
...
\pitm{b.} Delete randomizing {\it Swap\/} statement from the Select program.
