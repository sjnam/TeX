...
\begindisplay
\vbox{
\+\bf function $Sample(M, N)$\cr
\+\quad\bf if $M = 0$ then\cr
\+\qquad {\bf return} the empty set\cr
\+\quad\bf else\cr
\+\qquad $S := Sample(M-1, N-1)$\cr
\+\qquad $T := RandInt(1, N)$\cr
\+\qquad\bf if $T \not\in S$ then\cr
...
\+\quad $j := RandInt(1, i)$\cr
\+\quad $Swap(X[j], X[i])$\cr}
\enddisplay
