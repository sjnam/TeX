...
\def\lheader{\ninerm\the\pageno\quad\sc more programming pearls\hfill\colnum}
\def\rheader{\sc\colnum\hfill a sample of brilliance\quad{\ninerm\the\pageno}}
\titletrue
...
\rightline{\twelverm COLUMN 13:\quad{\titlefont A SAMPLE OF BRILLIANCE}}
\vskip 1in
...
\newcount\pno
\outer\def\prob{\penalty-50\bigskip\hangindent 1.5em
