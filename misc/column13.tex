...
$L+{\bf int}(rand\times(U+1-L)).$ In the unlikely event that your system doesn't even
...
and if $randint$ produces random integers, then the algorithm produces a
...
\alg S\ is a pretty good algorithm, but not good enough for Bob Floyd. Not content
